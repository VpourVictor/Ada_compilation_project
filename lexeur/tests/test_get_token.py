...
import lexeur.file_to_code_ter as fileCode
...
class MyTestCase(unittest.TestCase):
    def test_dictionnaire_ascii(self):
        ...
        self.assertEqual(fileCode.get_token("../exemples/intro.ada"),
        ...
        self.assertEqual(fileCode.get_token("../exemples/exemple_procedure.ada"),
        ...
        self.assertEqual(fileCode.get_token("../exemples/exemple_while.ada"),
